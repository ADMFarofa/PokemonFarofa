...
function load()
  ...
  if filename then
    datPath = resolvepath('/things/854/' .. filename)
    sprPath = resolvepath('/things/854/' .. filename)
  else
    datPath = resolvepath('/things/' .. version .. '/Mysterious')
    sprPath = resolvepath('/things/' .. version .. '/Mysterious')
  end
